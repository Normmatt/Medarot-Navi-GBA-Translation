; Medarot Navi Script 196 Strings

id_196_subid_0_string1:
	.string "<F:6C>みなのしゅう なげかわしいことに…<NL><WAIT>おいどんらは 中学生ごときに<NL>ここのところ おされ気味でごわす!"

id_196_subid_0_string2:
	.string "<F:6C>その げんいんは なにか?<NL>分かるでごわすか?"

id_196_subid_0_string3:
	.string "<F:7D>やっぱリ…<NL>"

id_196_subid_0_string4:
	.string "<F:7D>あの <PLAYER>とか言う こぞうの<NL>メダルの力 ロボか?"

id_196_subid_0_string5:
	.string "<F:7D>いや れいせいに ぶんせきすると<NL><WAIT><PLAYER>の 持ってる<NL>パーツに 違いないロボ!"

id_196_subid_0_string6:
	.string "<F:7D>違うロボ! あの<PLAYER>の 作戦に<NL>してやられてるロボ!"

id_196_subid_0_string7:
