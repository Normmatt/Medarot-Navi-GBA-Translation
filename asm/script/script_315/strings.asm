; Medarot Navi Script 315 Strings

id_315_subid_0_string1:
	.string "<F:03>うわぁー すげえ!<NL>こんなの 見た事 ないよ!"

id_315_subid_2_string2:
	.string "<F:19>材質からして<NL>地球の 物じゃ ないでやんすね<WAIT><F:14>ここは どういう 場所 なんやろ?<WAIT><F:0F>おそらくは 宇宙船の ドックのような<NL>場所じゃ ないかな?<WAIT>でなければ にもつの はんにゅうぐち?<NL>"

id_315_subid_2_string3:
	.string "<F:0F>まぁ 地球外文明の 物だろうから<NL>ぜんぜん マト外れかも しれないけど…"

id_315_subid_3_string4:
	.string "<F:0D>不思議な 材質だな…<NL><WAIT>なにで できてるんだ?"

id_315_subid_3_string5:
	.string "<F:55>ああっ!<NL><WAIT>いけません!!<NL>みだリに 手で ふれては 危険…"

id_315_subid_3_string6:
	.string "<F:54>ああっ!"
